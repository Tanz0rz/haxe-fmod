...
/**
 * A playing sound returned by FmodManager.PlayEvent. It wraps a typed event instance handle.
 *
...
abstract FmodEvent(EventInstance) from EventInstance to EventInstance {
    ...
    /** Starts a sound from FmodManager.CreateEvent. A sound from PlayEvent is already started, and starting it again restarts it from the beginning. */
