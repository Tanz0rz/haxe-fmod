...
enum EventCallbackData {
     ...
     * The event owns it, so its release() is refused. On C++ and HashLink an
     * instance records at most 64 live plugin instruments. A further one
     * arrives with Dsp.NULL.
     */
