...
class NativeStudioStub {
    ...
    // Plugins
    /** The last plugin path and priority handed to the stub, for the unit tests. */
    public static var testLastPluginPath:String = null;
    public static var testLastPluginPriority:Int = -1;
    public static function sys_set_plugin_path(path:String):Int {
        testLastPluginPath = path;
        return ERR_UNSUPPORTED;
    }
    public static function sys_load_plugin(path:String, priority:Int):Int {
        testLastPluginPath = path;
        testLastPluginPriority = priority;
        return 0;
    }
