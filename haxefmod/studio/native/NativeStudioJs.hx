...
class NativeStudioJs {
    ...
    public static inline function sys_last_parameter_guid():String return Raw.fmod_sys_last_parameter_guid();
    ...
    public static function sys_set_listener_attributes(index:Int, px:Float, py:Float, pz:Float, vx:Float, vy:Float, vz:Float, fx:Float, fy:Float, fz:Float, ux:Float, uy:Float, uz:Float, hasAttenuation:Bool, ax:Float, ay:Float, az:Float):Int {
        ...
        return Raw.fmod_sys_set_listener_attributes(index, Scratch.floatBuf(), hasAttenuation);
    }
    ...
    public static inline function core_sound_is_owned(handle:Int):Bool return Raw.fmod_core_sound_is_owned(handle);
    ...
    public static inline function chan_get_position(handle:Int, unit:Int):Int return Raw.fmod_chan_get_position(handle, unit);
    public static inline function chan_set_position(handle:Int, position:Int, unit:Int):Int return Raw.fmod_chan_set_position(handle, position, unit);
    ...
    public static inline function dsp_disconnect_from(handle:Int, inputHandle:Int, connHandle:Int):Int return Raw.fmod_dsp_disconnect_from(handle, inputHandle, connHandle);
    ...
    public static inline function cg_add_group(handle:Int, childHandle:Int, propagateDspClock:Bool):Int return Raw.fmod_cg_add_group(handle, childHandle, propagateDspClock);
    ...
    public static inline function chan_set_mix_matrix(handle:Int, outChannels:Int, inChannels:Int, inChannelHop:Int):Int return Raw.fmod_chan_set_mix_matrix(handle, Scratch.floatBuf(), outChannels, inChannels, inChannelHop);
    ...
    public static inline function sound_get_open_state_info(handle:Int):Int return Raw.fmod_sound_get_open_state_info(handle, Scratch.intBuf());
    ...
    public static inline function sound_add_sync_point(handle:Int, offset:Int, unit:Int, name:String):Int return Raw.fmod_sound_add_sync_point(handle, offset, unit, name);
    ...
    public static inline function sound_get_sync_point_offset(handle:Int, index:Int, unit:Int):Int return Raw.fmod_sound_get_sync_point_offset(handle, index, unit);
    ...
    public static inline function sys_load_bank_memory(data:haxe.io.Bytes, len:Int, flags:Int):Int return Raw.fmod_sys_load_bank_memory(data == null ? null : data.getData(), len, flags);
    ...
    public static inline function sys_start_command_capture(path:String, flags:Int):Int return Raw.fmod_sys_start_command_capture(path, flags);
    public static inline function sys_stop_command_capture():Int return Raw.fmod_sys_stop_command_capture();
    public static inline function sys_load_command_replay(path:String, flags:Int):Int return Raw.fmod_sys_load_command_replay(path, flags);
    ...
    public static inline function replay_seek_to_time(handle:Int, seconds:Float):Int return Raw.fmod_replay_seek_to_time(handle, seconds);
    ...
    public static inline function dsp_set_param_data(handle:Int, index:Int, data:haxe.io.Bytes, len:Int):Int return Raw.fmod_dsp_set_param_data(handle, index, data == null ? null : data.getData(), len);
    ...
    public static inline function cg_get_3d_occlusion(handle:Int):Int return Raw.fmod_cg_get_3d_occlusion(handle, Scratch.floatBuf());
    public static inline function cg_get_delay(handle:Int):Int return Raw.fmod_cg_get_delay(handle, Scratch.floatBuf());
    public static inline function cg_get_low_pass_gain(handle:Int):Float return Raw.fmod_cg_get_low_pass_gain(handle);
    public static inline function cg_is_playing(handle:Int):Bool return Raw.fmod_cg_is_playing(handle);
    public static inline function cg_set_callback(handle:Int, enabled:Bool):Int return Raw.fmod_cg_set_callback(handle, enabled);
    ...
    /** Matrix rows go through the Scratch float buffer, out*in gains row-major. */
    public static inline function cg_set_mix_matrix(handle:Int, outChannels:Int, inChannels:Int, inChannelHop:Int):Int return Raw.fmod_cg_set_mix_matrix(handle, Scratch.floatBuf(), outChannels, inChannels, inChannelHop);
    ...
    public static inline function chan_get_mix_matrix(handle:Int, inChannelHop:Int):Int return Raw.fmod_chan_get_mix_matrix(handle, Scratch.floatBuf(), Scratch.intBuf(), inChannelHop);
    ...
    public static inline function cg_get_mix_matrix(handle:Int, inChannelHop:Int):Int return Raw.fmod_cg_get_mix_matrix(handle, Scratch.floatBuf(), Scratch.intBuf(), inChannelHop);
    ...
    public static inline function dsp_get_info(handle:Int):String return Raw.fmod_dsp_get_info(handle, Scratch.intBuf());
    /** Copies up to cap bytes of the data block into out (null asks for the size). Returns the length, -1 on failure. */
    public static inline function dsp_get_param_data(handle:Int, index:Int, out:haxe.io.Bytes, cap:Int):Int return Raw.fmod_dsp_get_param_data(handle, index, out == null ? null : out.getData(), cap);
    /** Scratch float buffer [0..23] = relative then absolute attributes. */
    public static inline function dsp_set_param_3d_attributes(handle:Int, index:Int):Int return Raw.fmod_dsp_set_param_3d_attributes(handle, index, Scratch.floatBuf());
    /** Scratch float buffer [0..115] = relative[8], weight[8], absolute. */
    public static inline function dsp_set_param_3d_attributes_multi(handle:Int, index:Int, numListeners:Int):Int return Raw.fmod_dsp_set_param_3d_attributes_multi(handle, index, numListeners, Scratch.floatBuf());
    /** Fills Scratch float buffer peak then rms per channel, int buffer [0] numsamples, [1] numchannels. Returns the channel count. */
    public static inline function dsp_get_metering_info(handle:Int, input:Bool):Int return Raw.fmod_dsp_get_metering_info(handle, input, Scratch.floatBuf(), Scratch.intBuf());
    /** Fills Scratch float buffer with one channel's bins, int buffer [0] numchannels, [1] length. Returns the bins written. */
    public static inline function dsp_fft_get_spectrum_channel(handle:Int, channel:Int, maxBins:Int):Int return Raw.fmod_dsp_fft_get_spectrum_channel(handle, channel, Scratch.floatBuf(), maxBins, Scratch.intBuf());
    public static inline function dsp_get_parameter_text(handle:Int, index:Int, kind:Int):String return Raw.fmod_dsp_get_parameter_text(handle, index, kind);
    /** A typed data parameter of the faxe_dspdata.h kind from the Scratch float and int buffers. Returns the FMOD result. */
    public static inline function dsp_set_param_typed(handle:Int, index:Int, kind:Int):Int return Raw.fmod_dsp_set_param_typed(handle, index, kind, Scratch.floatBuf(), Scratch.intBuf());
    /** Reads a data parameter back as the faxe_dspdata.h kind into the Scratch float and int buffers. Returns the FMOD result. */
    public static inline function dsp_get_param_typed(handle:Int, index:Int, kind:Int):Int return Raw.fmod_dsp_get_param_typed(handle, index, kind, Scratch.floatBuf(), Scratch.intBuf());
    ...
    public static inline function conn_set_mix_matrix(handle:Int, outChannels:Int, inChannels:Int, inChannelHop:Int):Int return Raw.fmod_conn_set_mix_matrix(handle, Scratch.floatBuf(), outChannels, inChannels, inChannelHop);
    public static inline function conn_get_mix_matrix(handle:Int, inChannelHop:Int):Int return Raw.fmod_conn_get_mix_matrix(handle, Scratch.floatBuf(), Scratch.intBuf(), inChannelHop);
    ...
    public static inline function core_sound_get_music_num_channels(handle:Int):Int return Raw.fmod_core_sound_get_music_num_channels(handle);
    public static inline function core_sound_set_music_channel_volume(handle:Int, channel:Int, volume:Float):Int return Raw.fmod_core_sound_set_music_channel_volume(handle, channel, volume);
    public static inline function core_sound_get_music_channel_volume(handle:Int, channel:Int):Float return Raw.fmod_core_sound_get_music_channel_volume(handle, channel);
    public static inline function core_sound_set_music_speed(handle:Int, speed:Float):Int return Raw.fmod_core_sound_set_music_speed(handle, speed);
    public static inline function core_sound_get_music_speed(handle:Int):Float return Raw.fmod_core_sound_get_music_speed(handle);
    public static inline function core_sound_get_num_sub_sounds(handle:Int):Int return Raw.fmod_core_sound_get_num_sub_sounds(handle);
    public static inline function core_sound_get_sub_sound(handle:Int, index:Int):Int return Raw.fmod_core_sound_get_sub_sound(handle, index);
    public static inline function core_sound_get_sub_sound_parent(handle:Int):Int return Raw.fmod_core_sound_get_sub_sound_parent(handle);
    public static inline function core_sound_get_num_tags(handle:Int):Int return Raw.fmod_core_sound_get_num_tags(handle, Scratch.intBuf());
    public static inline function core_sound_get_tag(handle:Int, name:String, index:Int):String return Raw.fmod_core_sound_get_tag(handle, name, index, Scratch.intBuf(), Scratch.floatBuf());
    ...
    public static inline function sys_set_init_format(outputType:Int, resamplerMethod:Int, rawSpeakers:Int):Int return Raw.fmod_sys_set_init_format(outputType, resamplerMethod, rawSpeakers);
    public static inline function sys_memory_initialize(poolSize:Int):Int return Raw.fmod_sys_memory_initialize(poolSize);
    public static inline function sys_thread_set_attributes(type:Int, priority:Int, stackSize:Int, affinity:Int):Int return Raw.fmod_sys_thread_set_attributes(type, priority, stackSize, affinity);
    public static inline function sys_debug_initialize(flags:Int, mode:Int, filename:String):Int return Raw.fmod_sys_debug_initialize(flags, mode, filename);
    public static inline function sys_get_driver_info(id:Int):String return Raw.fmod_sys_get_driver_info(id, Scratch.intBuf());
...
private extern class Raw {
    ...
    static function fmod_sys_last_parameter_guid():String;
    ...
    static function fmod_sys_set_listener_attributes(index:Int, f:Array<Float>, hasAttenuation:Bool):Int;
    ...
    static function fmod_sys_init_ex(numChannels:Int, sampleRate:Int, speakerMode:Int, studioFlags:Int, dspBufferLength:Int, dspNumBuffers:Int, softwareChannels:Int, streamBufferSize:Int, initFlags:Int, maxMPEGCodecs:Int, maxVorbisCodecs:Int, maxFADPCMCodecs:Int, vol0VirtualVol:Float, defaultDecodeBufferSize:Int, profilePort:Int, geometryMaxFadeTime:Int, distanceFilterCenterFreq:Float, randomSeed:Int, commandQueueSize:Int, handleInitialSize:Int, studioUpdatePeriod:Int, idleSampleDataPoolSize:Int, streamingScheduleDelay:Int, encryptionKey:String):Int;
    ...
    static function fmod_core_sound_is_owned(handle:Int):Bool;
    ...
    static function fmod_chan_get_position(handle:Int, unit:Int):Int;
    static function fmod_chan_set_position(handle:Int, position:Int, unit:Int):Int;
    ...
    static function fmod_dsp_disconnect_from(handle:Int, inputHandle:Int, connHandle:Int):Int;
    ...
    static function fmod_cg_add_group(handle:Int, childHandle:Int, propagateDspClock:Bool):Int;
    ...
    static function fmod_chan_set_mix_matrix(handle:Int, fbuf:Array<Float>, outChannels:Int, inChannels:Int, inChannelHop:Int):Int;
    ...
    static function fmod_sound_get_open_state_info(handle:Int, ibuf:Array<Int>):Int;
    ...
    static function fmod_sound_add_sync_point(handle:Int, offset:Int, unit:Int, name:String):Int;
    ...
    static function fmod_sound_get_sync_point_offset(handle:Int, index:Int, unit:Int):Int;
    ...
    static function fmod_sys_load_bank_memory(data:haxe.io.BytesData, len:Int, flags:Int):Int;
    static function fmod_evi_get_channel_group(handle:Int):Int;
    static function fmod_sys_start_command_capture(path:String, flags:Int):Int;
    static function fmod_sys_stop_command_capture():Int;
    static function fmod_sys_load_command_replay(path:String, flags:Int):Int;
    ...
    static function fmod_replay_seek_to_time(handle:Int, seconds:Float):Int;
    ...
    static function fmod_cg_get_3d_occlusion(handle:Int, fbuf:Array<Float>):Int;
    static function fmod_cg_get_delay(handle:Int, fbuf:Array<Float>):Int;
    static function fmod_cg_get_low_pass_gain(handle:Int):Float;
    static function fmod_cg_is_playing(handle:Int):Bool;
    static function fmod_cg_set_callback(handle:Int, enabled:Bool):Int;
    ...
    static function fmod_cg_set_mix_matrix(handle:Int, fbuf:Array<Float>, outChannels:Int, inChannels:Int, inChannelHop:Int):Int;
    ...
    static function fmod_chan_get_mix_matrix(handle:Int, fbuf:Array<Float>, ibuf:Array<Int>, inChannelHop:Int):Int;
    ...
    static function fmod_cg_get_mix_matrix(handle:Int, fbuf:Array<Float>, ibuf:Array<Int>, inChannelHop:Int):Int;
    ...
    static function fmod_dsp_get_info(handle:Int, ibuf:Array<Int>):String;
    static function fmod_dsp_get_param_data(handle:Int, index:Int, out:haxe.io.BytesData, cap:Int):Int;
    static function fmod_dsp_set_param_3d_attributes(handle:Int, index:Int, fbuf:Array<Float>):Int;
    static function fmod_dsp_set_param_3d_attributes_multi(handle:Int, index:Int, numListeners:Int, fbuf:Array<Float>):Int;
    static function fmod_dsp_get_metering_info(handle:Int, input:Bool, fbuf:Array<Float>, ibuf:Array<Int>):Int;
    static function fmod_dsp_fft_get_spectrum_channel(handle:Int, channel:Int, fbuf:Array<Float>, maxBins:Int, ibuf:Array<Int>):Int;
    static function fmod_dsp_get_parameter_text(handle:Int, index:Int, kind:Int):String;
    static function fmod_dsp_set_param_typed(handle:Int, index:Int, kind:Int, fbuf:Array<Float>, ibuf:Array<Int>):Int;
    static function fmod_dsp_get_param_typed(handle:Int, index:Int, kind:Int, fbuf:Array<Float>, ibuf:Array<Int>):Int;
    ...
    static function fmod_conn_set_mix_matrix(handle:Int, fbuf:Array<Float>, outChannels:Int, inChannels:Int, inChannelHop:Int):Int;
    ...
    // Sound extras: tracker music, subsounds, tags, and advanced settings readback
    static function fmod_core_sound_get_music_num_channels(handle:Int):Int;
    static function fmod_core_sound_set_music_channel_volume(handle:Int, channel:Int, volume:Float):Int;
    static function fmod_core_sound_get_music_channel_volume(handle:Int, channel:Int):Float;
    static function fmod_core_sound_set_music_speed(handle:Int, speed:Float):Int;
    static function fmod_core_sound_get_music_speed(handle:Int):Float;
    static function fmod_core_sound_get_num_sub_sounds(handle:Int):Int;
    static function fmod_core_sound_get_sub_sound(handle:Int, index:Int):Int;
    static function fmod_core_sound_get_sub_sound_parent(handle:Int):Int;
    static function fmod_core_sound_get_num_tags(handle:Int, ibuf:Array<Int>):Int;
    static function fmod_core_sound_get_tag(handle:Int, name:String, index:Int, ibuf:Array<Int>, fbuf:Array<Float>):String;
    ...
    static function fmod_sys_set_init_format(outputType:Int, resamplerMethod:Int, rawSpeakers:Int):Int;
    static function fmod_sys_memory_initialize(poolSize:Int):Int;
    static function fmod_sys_thread_set_attributes(type:Int, priority:Int, stackSize:Int, affinity:Int):Int;
    static function fmod_sys_debug_initialize(flags:Int, mode:Int, filename:String):Int;
    static function fmod_sys_get_driver_info(id:Int, ibuf:Array<Int>):String;
