...
verdict: cannot output plugins are written in C. FMOD initializes the platform's default output. StudioSystem.loadPlugin with CoreSystem.setOutputByPlugin selects a compiled one
