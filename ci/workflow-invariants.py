...
REQUIRED_STEPS = {
    ...
    "mac-hl": ["Record audio", "Record volume test", "Run state", "Validate synth audio", "Run stress-test state (smoke)"],
    "windows-cpp-build": ["Build C++ target", "Validate build output", "Test native headers with MSVC (C and C++ modes)"],
    "windows-cpp": ["Record audio", "Record volume test", "Run state", "Validate synth audio", "Run stress-test state (smoke)"],
    ...
    "windows-hl": ["Record audio", "Record volume test", "Run state", "Validate synth audio", "Run stress-test state (smoke)"],
    ...
    "linux-html5-chromium": ["Record audio", "Record volume test", "Run state", "Validate synth audio"],
    "heaps-hl-build": ["Build test variant", "Validate build output"],
    "heaps-hl-build-manual": ["Build test variant", "Validate build output"],
    "heaps-hl": ["Record audio", "Record volume test", "Run state", "Validate synth audio", "Run stress-test state (smoke)", "Run api-probe state (manual update variant)"],
    ...
    "kha-linux": ["Record audio", "Record volume test", "Run state", "Validate synth audio", "Run stress-test state (smoke)", "Run api-probe state (manual update variant)"],
