...
GATED = [
    ...
    ("StudioSystem", "recordStart", "haxefmod/studio/StudioSystem.hx",
     "var s:CoreSound = cast 1; var r = StudioSystem.recordStart(0, s, true);"),
    ...
    ("CoreSound", "createRecordBuffer", "haxefmod/studio/CoreSound.hx",
     "var r = CoreSound.createRecordBuffer(48000, 1, 1);"),
    ("CoreSound", "readData", "haxefmod/studio/CoreSound.hx",
     "var s:CoreSound = cast 1; var r = s.readData(haxe.io.Bytes.alloc(16));"),
    ("CoreSound", "seekData", "haxefmod/studio/CoreSound.hx",
     "var s:CoreSound = cast 1; var r = s.seekData(0);"),
    ("CoreSound", "set3DCustomRolloff", "haxefmod/studio/CoreSound.hx",
     "var s:CoreSound = cast 1; var r = s.set3DCustomRolloff([" + V + "]);"),
    ("CoreSound", "get3DCustomRolloff", "haxefmod/studio/CoreSound.hx",
     "var s:CoreSound = cast 1; var r = s.get3DCustomRolloff();"),
