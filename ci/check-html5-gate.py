...
GATED = [
    ...
    ("Sound", "lock", "haxefmod/core/Sound.hx",
     "var s:Sound = cast 1; var r = s.lock(0, 16);"),
    ("Sound", "unlock", "haxefmod/core/Sound.hx",
     "var s:Sound = cast 1; var r = s.unlock(haxe.io.Bytes.alloc(16));"),
    ("CoreSystem", "setDiskBusy", "haxefmod/core/CoreSystem.hx",
     "var r = CoreSystem.setDiskBusy(true);"),
    ("CoreSystem", "getDiskBusy", "haxefmod/core/CoreSystem.hx",
     "var r = CoreSystem.getDiskBusy();"),
    ...
    ("Channel", "getMixMatrix", "haxefmod/core/Channel.hx",
     "var c:Channel = cast 1; var r = c.getMixMatrix();"),
    ...
    ("ChannelGroup", "getMixMatrix", "haxefmod/core/ChannelGroup.hx",
     "var g:ChannelGroup = cast 1; var r = g.getMixMatrix();"),
    ("DspConnection", "getMixMatrix", "haxefmod/core/DspConnection.hx",
     "var c:DspConnection = cast 1; var r = c.getMixMatrix();"),
