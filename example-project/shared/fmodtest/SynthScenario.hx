...
/**
 * CI test scenario proving Haxe-generated PCM reaches the audio output.
 *
 ...
 */
class SynthScenario implements TestScenario {
    var host:TestHost;
    ...
    public function create(host:TestHost):Void {
        ...
        host.setStatus("SYNTH_TEST running");
    ...
    function startSegment(index:Int):Void {
        ...
        host.setStatus('SYNTH_TEST segment ${index + 1}');
    ...
    function finish():Void {
        _complete = true;
        host.setStatus(_failed ? "SYNTH_TEST failed" : "SYNTH_TEST complete");
